...
<head>
    ...
    <title>@yield('title', 'NGO Member Dashboard')</title>
...
<body>
    ...
    @include('members.masters.includes.sidebar')
    @include('members.masters.includes.header')
    <main id="main-content">
        @yield('content')
    </main>
    @include('members.masters.includes.footer')
    @stack('scripts')
</body>
